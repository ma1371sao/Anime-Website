...
<body>
	<input type="hidden" id="orignpath" value="<?php echo ($pic["pic"]); ?>"/>
	<img src="<?php echo ($pic["pic"]); ?>" id="img-crop"/>
	...
	<div class="crop crop_large" id="large"><img id="crop-preview-large" src="<?php echo ($pic["pic"]); ?>" alt=""></div>
	<div class="crop crop_small" id="small"><img id="crop-preview-small" src="<?php echo ($pic["pic"]); ?>" alt=""></div>
...
$(function() {
	...
	$(".submit").click(function(){
		...
		$.post("<?php echo U('cropImage');?>",{img:pic,x:x,y:y,w:w,h:h,type:num},function (data){
			if(data['status'] == 1){
